  ...
  return (
    <div className="min-h-screen mt-15 bg-linear-to-br from-cyan-50 to-white flex flex-col">
      ...
      <main className="flex-1 py-12 space-y-10">
        ...
        <div className="w-full grid grid-cols-4 h-[80vh] relative overflow-hidden" style={{backgroundImage: 'url("https://imagine-public.x.ai/imagine-public/images/1fab00e1-5785-42db-a02f-48883647c1e2.png?cache=1")', backgroundRepeat: "no-repeat", backgroundSize: "cover", backgroundPosition: "center" }}></div>
