          ...
          {closeBtn && (
            ...
            <div className='z-20 relative p-3'>       
              ...
              </div> 
              {
                ...
                (
                  <div>
                  <p className='flex justify-between p-3 border-b border-indigo-500 bg-indigo-200 rounded-t-lg cursor-pointer items-center' onClick={()=>{setViewMin(prev=>!prev); setViewMach(false); setViewEquip(false)}}> Minerals {viewMin ? <FaChevronUp/> : <FaChevronDown/> } </p>
                  { viewMin && (
                  ...
                  <p className='flex justify-between p-3 border-b border-indigo-500 bg-indigo-200 rounded-t-lg cursor-pointer items-center' onClick={()=>{setViewMach(prev=>!prev); setViewMin(false); setViewEquip(false)}}> Heavy Duty Machines {viewMach ? <FaChevronUp/> : <FaChevronDown/> } </p>
                  { viewMach && (
                  ...
                  <p className='flex justify-between p-3 border-b border-indigo-500 bg-indigo-200 rounded-t-lg cursor-pointer items-center' onClick={()=>{setViewEquip(prev=>!prev); setViewMin(false); setViewMach(false)}}> Equipment {viewMach ? <FaChevronUp/> : <FaChevronDown/> } </p>
                  { viewEquip && (
