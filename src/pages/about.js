      ...
      <main className="flex-1 py-12 space-y-10">
        ...
        <div className='max-w-6xl mx-auto px-2'>
          ...
          <section className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6 text-gray-800">
            <div className="p-3 bg-white border rounded flex items-center gap-5"><img className='w-28' src="public/images/vision.png" /><div><strong>Vision</strong><br/><p>To be a globally respected African conglomerate...</p></div></div>
            <div className="p-3 bg-white border rounded flex items-center gap-5"><img className='w-28' src="public/images/mission.png" /><div><strong>Mission</strong><br/><p>Transforming lives and industries through responsible investment...</p></div></div>
            <div className="p-3 bg-white border rounded flex items-center gap-5"><img className='w-28' src="public/images/values.png" /><div><strong>Core Values</strong><br/><p>Integrity | Innovation | Excellence | Sustainability | Empowerment</p></div></div>
          </section>
        </div>
      </main>
      <Footer />
